                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="withScroll" data-height="320">
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar1.png" alt="avatar 1" width="35" class="pull-left">
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar2.png" alt="avatar 2" width="35" class="pull-left">
                                        <div class="media-body">
                                            <div class="pull-left">
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar3.png" alt="avatar 3" width="35" class="pull-left">
                                        <div class="media-body">
                                            <div class="pull-left">
                                                <p class="c-dark m-0"><strong>John Snow</strong>
                                                </p>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar4.png" alt="avatar 4" width="35" class="pull-left">
                                        <div class="media-body">
                                            <div class="pull-left">
                                                <p class="c-dark m-0"><strong>Jerry Smith</strong>
                                                </p>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar5.png" alt="avatar 5" width="35" class="pull-left">
                                        <div class="media-body">
                                            <div class="pull-left">
                                                <p class="c-dark m-0"><strong>John Snow</strong>
                                                </p>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar6.png" alt="avatar 6" width="35" class="pull-left">
                                        <div class="media-body">
                                            <div class="pull-left">
                                                <p class="c-dark m-0"><strong>Jerry Smith</strong>
                                                </p>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="withScroll" data-height="480">
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar13_big.png" alt="avatar 13" width="50" class="pull-left">
                                        <div class="media-body">
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar12_big.png" alt="avatar 12" width="50" class="pull-left">
                                        <div class="media-body">
                                            <small class="pull-right">23 Sept</small>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar11_big.png" alt="avatar 11" width="50" class="pull-left">
                                        <div class="media-body">
                                            <small class="pull-right">23 Sept</small>
                                            <h5 class="c-dark"><strong>John Snow</strong></h5>
                                            <h4 class="c-dark">Reset your account password</h4>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar10_big.png" alt="avatar 10" width="50" class="pull-left">
                                        <div class="media-body">
                                            <small class="pull-right">23 Sept</small>
                                            <h5 class="c-dark"><strong>Jerry Smith</strong></h5>
                                            <h4 class="c-dark">Check Dropbox</h4>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar9_big.png" alt="avatar 9" width="50" class="pull-left">
                                        <div class="media-body">
                                            <small class="pull-right">23 Sept</small>
                                            <h5 class="c-dark"><strong>John Snow</strong></h5>
                                            <h4 class="c-dark">Reset your account password</h4>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar8_big.png" alt="avatar 8" width="50" class="pull-left">
                                        <div class="media-body">
                                            <small class="pull-right">23 Sept</small>
                                            <h5 class="c-dark"><strong>Jerry Smith</strong></h5>
                                            <h4 class="c-dark">Check Dropbox</h4>
                                ...
                                <a href="#" class="message-item media">
                                    <div class="media">
                                        <img src="img/avatars/avatar7_big.png" alt="avatar 7" width="50" class="pull-left">
                                        <div class="media-body">
                                            <small class="pull-right">23 Sept</small>
                                            <h5 class="c-dark"><strong>John Snow</strong></h5>
                                            <h4 class="c-dark">Reset your account password</h4>
